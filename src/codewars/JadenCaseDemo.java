    ...
    public String toJadenCase(String phrase) {
        if (phrase != "" & phrase!= null) {
            ...
            for (int i = 0; i < JadenChar.length; i++) {
                if (i == 0) JadenChar[i] = Character.toUpperCase(JadenChar[i]);
                else if (JadenChar[i] == ' ') JadenChar[i + 1] = Character.toUpperCase(JadenChar[i + 1]);
            }
...
public class JadenCaseDemo {
    public static void main(String args[]) {
        ...
        System.out.println(JC.toJadenCase(""));
